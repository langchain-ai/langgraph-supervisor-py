...
def build_app():
    ...
    supervisor_prompt = (
        ...
        "  • route_agent – computes routes or generates interactive maps based on known coordinates (not responsible for address or postal code parsing).\n"
        "- Routing guide:\n"
        ...
        "  • Mapping, routing, or distance visualization (e.g., directions, interactive map) → route_agent\n"
        ...
        "insert route_agent only if route visualization or distance display is explicitly required.\n"
